            ...
            <div className="homepage-item-brands">
                ...
                <div >
                    <Row gutter={24} style={{ margin: "0" }}>
                        {tempData.map(item => {
                            return <Col xs={12} sm={12} md={8} lg={6} xl={4} ><CustomCard param={item.cateogry} handleClick={handleClick} hoverable={true} styleName="cart-category-square" imageUrl={item.imageUrl} title={item.title} /></Col>
                        })}
                    </Row>
                </div>
            </div>
